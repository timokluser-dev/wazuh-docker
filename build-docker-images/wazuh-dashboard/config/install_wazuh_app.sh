...
if [ "$MAJOR_BUILD" -gt "$MAJOR_CURRENT" ]; then
  WAZUH_APP=https://packages-dev.wazuh.com/staging/ui/dashboard/wazuh-${WAZUH_VERSION}-${WAZUH_UI_REVISION}.zip
  WAZUH_CHECK_UPDATES=https://packages-dev.wazuh.com/staging/ui/dashboard/wazuhCheckUpdates-${WAZUH_VERSION}-${WAZUH_UI_REVISION}.zip
